...
CREATE TABLE IF NOT EXISTS `GRADE_REPORT` (
  ...
  `Semester` INT ZEROFILL NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Student` (
  ...
  `GRADE_REPORT_Student_Number` INT NOT NULL,
  PRIMARY KEY (`Student_Number`),
  CONSTRAINT `fk_Student_DEPARTMENT1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Student_GRADE_REPORT1`
    FOREIGN KEY (`GRADE_REPORT_Student_Number`)
    REFERENCES `GRADE_REPORT` (`Student_Number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_Student_DEPARTMENT1_idx` ON `Student` (`DEPARTMENT_Code` ASC) VISIBLE;

CREATE INDEX `fk_Student_GRADE_REPORT1_idx` ON `Student` (`GRADE_REPORT_Student_Number` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `SECTION` (
  ...
  `Dept_Code` INT NOT NULL,
  `DEPARTMENT_Dept_Code` INT NOT NULL,
  PRIMARY KEY (`Course_Number`, `Section_Number`, `COURSE_Course_Number`),
...
CREATE UNIQUE INDEX `Dept_Code_UNIQUE` ON `SECTION` (`Dept_Code` ASC) VISIBLE;

CREATE INDEX `fk_SECTION_DEPARTMENT1_idx` ON `SECTION` (`DEPARTMENT_Dept_Code` ASC) VISIBLE;
